...
class CachedExtendedCoxnetSurvivalAnalysis(
    CachedFitMixin, ExtendedCoxnetSurvivalAnalysis
):
    def __init__(
        self,
        memory,
...
class CachedExtendedCoxPHSurvivalAnalysis(
    CachedFitMixin, ExtendedCoxPHSurvivalAnalysis
):
    def __init__(
        self,
        memory,
